...
<div class="w-full h-screen">
    ...
    <section class="flex w-full h-screen justify-center py-4 bg-gray-100" style="border-bottom: 50px solid #A78BFA;">
        ...
        <div class="flex flex-col" style="height:200px;width:380px;margin-top: 100px;">
            ...
            <form method="POST" action="{{ route('perfil.cadastrar.empresarial.store') }}" class="p-2 bg-purple-400" style="width:380px;">
                @csrf
                ...
                <div class="mt-0.5">
                    <label for="password" class="block mt-0.5 font-medium text-white dark:text-white text-sm">Senha</label>
                    <div class="relative">
                ...
                <div class="mt-0.5">
                    <label for="password_confirmation" class="block mt-0.5 font-medium text-white dark:text-white text-sm">Confirmar Senha</label>
                    <div class="relative">
                        ...
                        <button type="button" id="togglePasswordConfirm" class="absolute right-2 top-2 text-purple-400 cursor-pointer">
                    ...
                    <x-input-error :messages="$errors->get('confirm_password')" class="mt-0.5" />
                </div>
                <div class="mt-0.5">
                    <label for="phone" class="block mb-1 font-medium text-white dark:text-white text-sm">Telefone</label>
                    <input type="tel" name="phone" id="phone" class="border border-gray-300 text-lg rounded-lg text-purple-400 block w-full p-2.5 focus:border-transparent focus:ring-0 focus:outline-none" placeholder=" " />
