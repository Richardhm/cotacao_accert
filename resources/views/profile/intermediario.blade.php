...
<div class="w-full h-screen">
    ...
    <section class="flex w-full h-screen justify-center py-4 bg-gray-100" style="border-bottom: 50px solid #A78BFA;">
        ...
        <div class="flex flex-col" style="height:200px;width:380px;margin-top: 100px;">
            ...
            <form method="POST" action="{{ route('perfil.cadastrar.intermediario.store') }}" class="p-2 bg-purple-400" style="width:380px;">
                @csrf


                <div class="mb-0.5">
                    <label for="name" class="block mb-0.5 font-medium text-white dark:text-white text-sm">Nome</label>
                    <input type="text" name="name" id="name" class="border border-gray-300 text-lg rounded-lg text-purple-400 block w-full p-2.5 focus:border-transparent focus:ring-0 focus:outline-none" />
                    <x-input-error :messages="$errors->get('name')" class="mt-0.5" />
                </div>
                <div class="mb-0.5">
                    <label for="email" class="block mb-0.5 font-medium text-white dark:text-white text-sm">Email</label>
                    <input type="email" name="email" id="email" class="border border-gray-300 text-lg rounded-lg text-purple-400 block w-full p-2.5 focus:border-transparent focus:ring-0 focus:outline-none" />
                    <x-input-error :messages="$errors->get('email')" class="mt-0.5" />
                </div>
                <div class="mb-0.5">
                    <label for="password" class="block mb-0.5 font-medium text-white dark:text-white text-sm">Senha</label>
                    <div class="relative">
                        <input type="password" name="password" id="password" class="border border-gray-300 text-lg rounded-lg ring-0 text-purple-400 block w-full p-2.5 focus:border-transparent focus:ring-0 focus:outline-none" />
                ...
                <div class="mb-0.5">
                    <label for="password_confirmation" class="block mb-0.5 font-medium text-white dark:text-white text-sm">Confirmar Senha</label>
                    <div class="relative">
                        <input type="password" name="password_confirmation" id="password_confirmation" class="border border-gray-300 text-lg rounded-lg bg-gray-50 ring-0 border border-gray-300 text-purple-400 block w-full p-2.5 focus:border-transparent focus:ring-0 focus:outline-none" />
                ...
                <div class="mb-0.5">
                    <label for="phone" class="block mb-0.5 font-medium text-white dark:text-white text-sm">Telefone</label>
                    <input type="tel" name="phone" id="phone" class="border border-gray-300 text-lg rounded-lg bg-gray-50 ring-0 text-purple-400 block w-full p-2.5 focus:border-transparent focus:ring-0 focus:outline-none" placeholder=" " />
