<div class="p-1 rounded mt-2 ml-3 mr-3" style="width:22%;background-color: #A78BFA;min-height:420px;" id="operadoras">
    <button class="py-2.5 w-full px-5 me-2 mb-2 text-sm font-medium text-white bg-white rounded-lg border border-gray-200 bg-gray-500 bg-opacity-10">
        ...
        @foreach($operadoras as $op)
            <label class="bg-white w-full container_image_operadora flex flex-wrap justify-between py-2.5 px-5 me-2 mb-2 text-sm font-medium text-white focus:outline-none bg-white rounded-lg border border-gray-200 focus:z-10 bg-gray-500 bg-opacity-10 dark:hover:text-gray-900">
