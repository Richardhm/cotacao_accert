...
@foreach($planos as $p)
    <div style="width:100%;" class="py-1 w-full px-1 me-2 mb-2 text-sm font-medium text-white focus:outline-none bg-white rounded-lg border border-gray-200 focus:z-10 bg-gray-500 bg-opacity-10 dark:hover:text-gray-900">
